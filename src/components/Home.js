...
export default class Home extends Component {
    render() {
        ...
        return (
            <div  style={{marginTop:"50px", backgroundSize:"100%",backgroundRepeat:"no-repeat", backgroundPosition:"fixed", marginBottom:"-120px"}} >
               <NavBarMain/>
        ...
        {/* <div className="bg"></div> */}
                ...
                <Container>
                  ...
                  <p className="lead black-text w-responsive text-center mx-auto mb-5">Our software company is the best company to conduct projects' financial management. </p>
<br/><br/><br/>
                  <div className="text-center" style={{color:'white'}}>
                    <Button  type="submit" className="btn-btn primary" href="/register" className="white-text">Register now.</Button>
                  </div>
                ...
                <div  style={{ marginTop:"100px",marginTop:"50px",backgroundRepeat:"no-repeat", backgroundAttachment:"fixed", backgroundSize:"100%", backgroundPosition:"fixed", marginBottom:"50px"}}>
        <Row>
          <div>
